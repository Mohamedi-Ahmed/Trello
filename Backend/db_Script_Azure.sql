...
CREATE TABLE UserProjects (
    ...
    CONSTRAINT FK_UserProjects_UserId FOREIGN KEY (UserId) REFERENCES Users(Id),
    CONSTRAINT FK_UserProjects_ProjectId FOREIGN KEY (ProjectId) REFERENCES Projects(Id)
);
...
CREATE TABLE Lists (
    ...
    Name NVARCHAR(255) NOT NULL,
    IdProject INT,
    CONSTRAINT FK_Lists_IdProject FOREIGN KEY (IdProject) REFERENCES Projects(Id) ON DELETE CASCADE
);
...
CREATE TABLE Cards (
    ...
    IdList INT,
    CreatorId INT,
    CONSTRAINT FK_Cards_IdList FOREIGN KEY (IdList) REFERENCES Lists(Id) ON DELETE CASCADE,
    CONSTRAINT FK_Cards_CreatorId FOREIGN KEY (CreatorId) REFERENCES Users(Id)
);
...
CREATE TABLE Comments (
    ...
    IdCard INT,
    UserId INT,
    CONSTRAINT FK_Comments_IdCard FOREIGN KEY (IdCard) REFERENCES Cards(Id) ON DELETE CASCADE,
